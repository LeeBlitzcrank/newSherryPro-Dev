...
public class ReadExcelUtil {
     ...
     * @return
     */
    public static List<ExcelModel> getExcelInfo(MultipartFile mFile) {
     ...
     * @throws IOException
     */
    public static List<ExcelModel> createExcel(InputStream is, boolean isExcel2003) {
        try {
            Workbook wb = null;
     ...
     * @return
     */
    private static List<ExcelModel> readExcelValue(Workbook wb) {
        //默认会跳过第一行标题
        // 得到第一个shell
        ...
        List<ExcelModel> userList = new ArrayList<ExcelModel>();
        // 循环Excel行数
        for (int r = 1; r < totalRows; r++) {
            ...
            ExcelModel user = new ExcelModel();
            // 循环Excel的列
